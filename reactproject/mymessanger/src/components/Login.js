...
class Login extends React.Component {
  ...
  handleClick () {
    ...
    this.setState({...this.state, error: {...this.state.error, email:emailError, password: passwordError}}, ()=>{ console.log('emailerror',this.state.error)} )
    ...
    return (
      <div className='App'>
          ...
          <div className='container'>
            ...
            <button className='submit opacity' onClick={() => this.handleClick()} >ورود </button>
